...
dens <- read.csv("C:/Users/brian/Dropbox/CU dept docs/students/Kate Hayes/working/density.csv")
...
#Question - why not compare the nested models (with the covariates) directly?  Use AIC if nested?
#Quasi P and NB - how deciding between the two now?
...
#model_parameters(mC_D.nb.solar.slope, exponentiate=T)
...
#I note that SOLAR has an estimated coefficient of zero again.  See comment above. Why does this version use elevation or slope but not both?
